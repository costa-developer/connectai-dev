...
import { PaperclipIcon, Send, Info } from 'lucide-react'
  ...
  <div className="flex items-center justify-between p-3 border-b sticky top-0 bg-white z-10">
    <div className="flex items-center space-x-3">
      ...
      <div className="flex flex-col">
        <span className="font-semibold text-gray-800">Tendai</span>
    ...
    <div className="flex-1 flex flex-col h-full bg-white max-h-screen">
          ...
          >
            {chats.length ? (
              ...
              <div className="text-center text-gray-500 mt-10">
                Start a conversation with Tendai
              </div>
            )}
          </div>
        </Loader>
      ...
      <div className="p-2 border-t bg-white">
        ...
        >
          ...
          <Button
            type="submit"
            className="p-0 h-10 w-10 rounded-full flex items-center justify-center bg-gray-900"
