...
const Hero = () => {
  ...
  return (
    <section
      className='bg-[#000510] relative py-24 pt-48 overflow-hidden z-1'
      id='main-banner'>
          ...
          <motion.div {...leftAnimation} className='flex flex-col gap-10'>
            <div className='flex flex-col gap-4 text-center md:text-left'>
              <div className='flex gap-6 items-center lg:justify-start justify-center'>
                <div className='py-1.5 px-4  rounded-full border border-gray-600'>
              ...
              <h1 className='font-medium xl:text-[72px] lg:text-6xl md:text-54 sm:text-5xl text-4xl md:text-start text-center text-white'>
                Drive Sales Faster and Smarter with AI Chat
              </h1>
              <p className='text-white'>
                Automate customer conversations, generate leads, and close deals faster with our intelligent sales assistant chatbot.
              </p>
            </div>
            <div className='flex items-center md:justify-start justify-center gap-8'>
              <Link
                href={'/#work'}
                className='bg-green hover:bg-primary/80 flex items-center gap-2 border border-primary rounded-lg font-semibold text-darkmode py-3 px-7 cursor-pointer'>
                Learn More
        ...
        <div className='fixed top-0 left-0 w-full h-full bg-black/50 flex items-center justify-center z-50'>
          <div
            ...
            <button
              ...
              <X className='text-white hover:text-primary w-6 h-6' />
            </button>
            <BuyCrypto />
          </div>
        </div>
