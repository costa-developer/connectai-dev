    ...
    <div className="w-full px-6 mx-auto mt-50">
        ...
        <div className="relative flex flex-col flex-auto min-w-0 p-4 mx-6 -mt-16 overflow-hidden break-words border-0 shadow-blur rounded-2xl bg-white/80 bg-clip-border backdrop-blur-2xl backdrop-saturate-200">
          ...
          <div className="flex-none w-auto max-w-full px-3">
            {/* Change h-18.5 w-18.5 to standard, smaller units like h-16 w-16 */}
            <div className="text-base ease-soft-in-out **h-16 w-16** relative inline-flex items-center justify-center rounded-xl text-white transition-all duration-200">
                {/* w-full ensures the image fills the <div> container */}
                <img src="/images/bruce-mars.jpg" alt="profile_image" className="**w-full h-full** shadow-soft-sm rounded-xl object-cover" />
            </div>
            </div>
            ...
            <div className="w-full max-w-full px-3 mx-auto mt-4 sm:my-auto sm:mr-0 md:w-1/2 md:flex-none lg:w-4/12">
              <div className="relative right-0">
                {/* Custom attributes like 'nav-pills' are changed to 'data-nav-pills' or removed */}
                <ul className="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl" data-nav-pills role="tablist">
                  <li className="z-30 flex-auto text-center">
                    {/* Custom attributes like 'nav-link' and 'active' are changed to 'data-nav-link' and 'data-active' or handled with className */}
                    <a className="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700" data-nav-link data-active href="javascript:;" role="tab" aria-selected="true">
                          ...
                          <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fillRule="nonzero">
                            <g transform="translate(1716.000000, 291.000000)">
                              <g transform="translate(603.000000, 0.000000)">
                                {/* CSS properties inside JSX/SVG must use camelCase (e.g., strokeWidth, fillRule) */}
                  ...
                  <li className="z-30 flex-auto text-center">
                    <a className="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700" data-nav-link href="javascript:;" role="tab" aria-selected="false">
