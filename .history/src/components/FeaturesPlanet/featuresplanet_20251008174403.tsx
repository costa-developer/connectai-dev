...
const PlanetCard: React.FC<PlanetCardProps> = ({ title, description, className }) => {
  return (
    <div
      className={`absolute z-10 animate-[float_4s_ease-in-out_infinite_both] opacity-80 transition-opacity duration-500 bg-gray-500 text-white p-3 rounded-lg shadow-lg ${className ?? ""}`}
    >
