...
const PlanetCard: React.FC<PlanetCardProps> = ({ title, description, className }) => {
  return (
    <div
      // Kept the larger, rectangular card style from the previous request
      className={`absolute z-10 w-48 animate-[float_4s_ease-in-out_infinite_both] opacity-80 transition-opacity duration-500 bg-blue-600 text-white p-4 rounded-lg shadow-lg ${className ?? ""}`}
    >
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="pb-16 md:pb-20" data-aos="zoom-y-out">
            <div className="text-center">
              {/* CHANGE 1: Replaced inline-flex with a wider, centered container (w-full lg:w-[600px] mx-auto) */}
              <div className="relative w-full lg:w-[600px] mx-auto rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-linear-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,var(--color-blue-500),transparent)]">
                <Image
                ...
                <div className="pointer-events-none" aria-hidden="true">
                  ...
                  />
                  <div>
                  {/* Card position adjustments for the new card size and container width */}
                  <PlanetCard
                    title="AI Insights"
                  ...
                  <PlanetCard
                    ...
                    // CHANGE 2: Moved slightly closer to the planet (was left-56)
                    className="left-48 top-7 animate-[float_4s_ease-in-out_infinite_1s_both] opacity-30"
                  />
                  <PlanetCard
                  ...
                  <PlanetCard
                    ...
                    // CHANGE 2: Moved slightly closer to the planet (was left-64)
                    className="bottom-32 left-56 animate-[float_4s_ease-in-out_infinite_3s_both] opacity-80"
                  />
                  </div>
                </div>
              </div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Automatically qualify leads and prioritize high-value prospects,
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>AI-Optimized Sales</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Let AI guide your sales conversations, suggest responses, and
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Customizable Scripts</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Tailor chatbot responses and workflows to match your brand voice
                and sales strategy effortlessly.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Engage customers worldwide 24/7 with multilingual AI responses
                that never miss a sales opportunity.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Connect your AI chatbot with existing CRM systems to log
                interactions, track leads, and automate follow-ups effortlessly.
              </p>
            </article>
          </div>
        </div>
