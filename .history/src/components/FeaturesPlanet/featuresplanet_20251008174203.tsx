...
const PlanetCard: React.FC<PlanetCardProps> = ({ title, description, className }) => {
  return (
    <div
      // CHANGES: Increased padding (p-4), added fixed width (w-48) for a rectangular shape.
    ...
    >
      {/* CHANGES: Increased font size for title to text-base */}
      <h4 className="font-semibold text-base">{title}</h4>
      {/* CHANGES: Increased font size for description to text-sm */}
