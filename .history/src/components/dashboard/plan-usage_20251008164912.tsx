  ...
  return (
    <div className="overflow-x-auto mt-5">
      <table className="min-w-full border border-gray-200 rounded-xl">
        <thead>
          <tr className="bg-gray-50 text-left text-sm font-semibold text-gray-600 rounded-2xl">
        ...
        <tbody>
          {metrics.map((metric) => (
            <tr
              key={metric.label}
              className="border-t rounded-2xl border-gray-200 hover:bg-gray-50 transition-colors"
            >
