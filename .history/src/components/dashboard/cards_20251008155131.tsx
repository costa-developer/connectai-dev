...
type Props = {
  ...
  gradient?: string // New prop to pass gradient classes
}
...
const DashboardCard = ({
  ...
  gradient = "bg-gradient-to-tl from-blue-600 to-cyan-400", // Default gradient
}: Props) => {
  return (
        ...
        <div className="flex-auto p-4">
          <div className="flex flex-row -mx-3">
            ...
            <div className="px-3 text-right basis-1/3">
              <div
                className={`inline-block w-12 h-12 text-center rounded-lg ${gradient} shadow-soft-md`}
              >
