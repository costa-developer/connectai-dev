      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="pb-12 text-center md:pb-16">
            <div
              className="relative border-2 border-transparent rounded-lg before:absolute before:inset-0 before:rounded-lg before:border-2 before:border-t-2 before:border-b-2 before:border-transparent before:bg-gradient-to-r before:from-slate-300 before:to-transparent"
              data-aos="zoom-y-out"
            >
