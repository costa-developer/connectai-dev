          ...
          <div
            ...
            >
              <div className="relative aspect-video rounded-2xl bg-gray-900 px-5 py-3 shadow-xl overflow-hidden 
                ...
                before:[border-image:linear-gradient(to_right,transparent,--theme(--color-slate-300/.8),transparent)1] 
                after:absolute after:-inset-5 after:-z-10 after:border-x 
                after:[border-image:linear-gradient(to_bottom,transparent,--theme(--color-slate-300/.8),transparent)1]"
              >
                {/* Background image */}
                <div
                  className="absolute inset-0 z-0"
                  style={{
                    backgroundImage: "url('https://images.unsplash.com/photo-1567598508481-65985588e295?w=900&auto=format&fit=crop&q=60')",
                    backgroundSize: "cover",
                    backgroundPosition: "center",
                    opacity: 0.2, // reduce opacity so it’s slightly visible
                  }}
                ></div>

                {/* Content on top */}
                <div className="relative z-10 mb-8 flex items-center justify-between before:block before:h-[9px] before:w-[41px] before:bg-[length:16px_9px] before:[background-image:radial-gradient(circle_at_4.5px_4.5px,var(--color-gray-600)_4.5px,transparent_0)] after:w-[41px]">
                  <span className="text-[13px] font-medium text-white">
                    cruip.com
                  </span>
                </div>

                <div className="font-mono text-gray-500 [&_span]:opacity-0 relative z-10">
