  ...
  return (
    <section className="relative">
      ...
      <div className="mt-10 md:mt-5 flex justify-center">
        <div className="relative w-full max-w-6xl px-4 md:px-0 rounded-lg border-4 border-blue-900 rounded-lg overflow-hidden shadow-2xl  shadow-black/5 backdrop-blur-md">
          <Image
