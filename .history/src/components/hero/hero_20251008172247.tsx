      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div
            ...
            data-aos-delay={600}
          >
            <div className="relative aspect-video rounded-2xl overflow-hidden border-0 shadow-[0_10px_30px_rgba(59,130,246,0.4)]">
              {/* Poster image using Next.js Image */}
              {!isPlaying && (
                <div
                  className="absolute inset-0 cursor-pointer outline-none focus:outline-none"
