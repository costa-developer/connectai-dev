...
const EmailMarketingDashboard = ({ campaign, domains, subscription }: Props) => {
  const {
    onSelectedEmails,
    isSelected,
    onCreateCampaign,
      ...
      <aside className="w-80 flex-shrink-0 bg-white border-r border-gray-200 flex flex-col p-4 shadow-lg">
        ...
        <Card className="p-3 mb-4 bg-yellow-50 border-yellow-200">
          <CardDescription className="font-semibold text-gray-700">
            Available Credits: <span className="text-lg font-extrabold text-orange-600">{subscription?.credits}</span>
          </CardDescription>
        </Card>
