...
export default function NavBar() {
  return (
    <header className="absolute top-0 left-0 right-0 z-30 flex flex-wrap items-center px-4 py-2 mx-6 my-4 shadow-soft-2xl rounded-xl bg-gray-50 backdrop-blur-2xl backdrop-saturate-200 lg:flex-nowrap lg:justify-start">
