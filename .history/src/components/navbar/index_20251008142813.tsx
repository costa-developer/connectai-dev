...
export default function NavBar() {
  return (
    <header className="absolute top-0 left-0 right-0 z-30 px-4 py-2 mx-6 my-4 shadow-soft-2xl rounded-blur bg-white/80 backdrop-blur-2xl backdrop-saturate-200">
