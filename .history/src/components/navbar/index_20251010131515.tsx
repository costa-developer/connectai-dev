...
export default function NavBar() {
  ...
  <Link
    href="/auth/sign-up"
    className="block px-5 py-2 text-[15px] font-semibold text-slate-700 hover:text-slate-900"
  >
    Sign Up
  </Link>
</li>
...
<li>
  <Link
    href="/auth/sign-in"
    className="mt-2 lg:mt-0 inline-block px-5 py-2 text-[15px] font-semibold text-white bg-gray-800 rounded-full hover:bg-gray-900 transition-all duration-200"
  >
    Sign In
  </Link>
</li>
