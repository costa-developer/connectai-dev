...
const BillingSettings = async (props: Props) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 rounded-2xl border-0 border-solid bg-white mt-8 p-4">
                  ...
                  <div className="flex justify-between items-end">
                    <div className="flex gap-6">
                      <div>
                        ...
                        <h6 className="mb-0 text-white">Tendai Gumunyu</h6>
                      </div>
                      <div>
                        <p className="mb-0 leading-normal text-white text-sm opacity-80">
                          Expires
