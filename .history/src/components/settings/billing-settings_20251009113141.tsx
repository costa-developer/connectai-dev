...
const BillingSettings = async (props: Props) => {
  ...
  const upgradePlanCard = (
    <Card className="border-dashed bg-card hover:bg-muted/50 transition-colors border-gray-400 w-full cursor-pointer h-[250px] flex justify-center items-center rounded-2xl border-0 border-solid bg-white">
