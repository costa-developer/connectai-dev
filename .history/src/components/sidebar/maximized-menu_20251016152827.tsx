...
const MaxMenu = ({ current, domains, onSignOut }: Props) => {
  ...
  <div className="relative flex min-w-0 flex-col items-center break-words rounded-2xl border-0 bg-white shadow-none overflow-hidden">
    ...
    <div
      ...
      style={{ backgroundImage: "url('/assets/img/curved-images/white-curved.jpeg')" }}
    ></div>
  ...
  <a
    ...
    target="_blank"
    className="inline-block w-full px-6 py-3 my-4 text-xs font-bold text-center text-white uppercase rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-md transition-all ease-in hover:shadow-soft-2xl hover:scale-102"
  >
    Upgrade to pro
  </a>
</div>
