...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-50 my-4 ml-4 flex w-full max-w-[250px] flex-col overflow-y-auto rounded-2xl  p-0 shadow-none transition-transform duration-200 ease-nav-brand
