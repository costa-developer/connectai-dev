              ...
              <div className="flex flex-wrap -mx-3">
                <div className="max-w-full px-3 lg:w-1/2 lg:flex-none">
                  <div className="flex flex-col h-full">
                    <p className="pt-2 mb-1 font-semibold text-gray-500">Powered by AI</p>
                    <h5 className="font-bold text-slate-900">Sales AI Accelerator</h5>
                    <p className="mb-12 text-gray-500">
                      Unlock smarter sales strategies with our AI-driven platform. From lead scoring to automated outreach, we optimize your sales workflow and boost conversions.
                    </p>
                    <a
        ...
        <div className="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
          <div className="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
            <div
              ...
              style={{ backgroundImage: "url('images/ivancik.jpg')" }}
            >
              <span className="absolute top-0 left-0 w-full h-full bg-center bg-cover bg-gradient-to-tl from-gray-900 to-slate-800 opacity-80"></span>
              <div className="relative z-10 flex flex-col flex-auto h-full p-4">
                <h5 className="pt-2 mb-6 font-bold text-white">Boost Your Sales</h5>
                <p className="text-white">
                  Leverage AI insights to identify top leads, personalize outreach, and accelerate revenue growth. Our platform helps sales teams win faster and smarter.
                </p>
                <a className="mt-auto mb-0 text-sm font-semibold leading-normal text-white group" href="#">
                  Get Started
                  <i className="fas fa-arrow-right ease-bounce text-sm group-hover:translate-x-1.25 ml-1 leading-normal transition-all duration-200"></i>
                </a>
              </div>
