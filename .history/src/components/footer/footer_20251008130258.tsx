...
export default function Footer({ border = false }: { border?: boolean }) {
  return (
    <footer className="relative">
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link href="#0" className="hover:text-gray-900 transition">
                  Features
                </Link>
              </li>
              <li>
          ...
          {/* 5th block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium text-gray-800">Social</h3>
      ...
      {/* Decorative big text and glow */}
      <div className="relative -mt-16 h-60 w-full" aria-hidden="true">
        <div className="absolute left-1/2 -translate-x-1/2 text-center text-[12rem] font-extrabold text-gray-200 opacity-10 select-none">
          Simple
        </div>
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2/3">
          <div className="h-56 w-56 rounded-full border-8 border-blue-700 blur-3xl"></div>
        </div>
      </div>
    </footer>
  );
