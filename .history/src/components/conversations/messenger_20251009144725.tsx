...
const Messenger = (props: Props) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-0 relative p-4">
      ...
      <form
        ...
        className="flex px-3 pt-3 pb-10 flex-col  rounded-2xl border-0 border-solid bg-gray-50 w-full"
      >
        <div className="flex justify-between">
          <Input
            {...register('content')}
            placeholder="Type your message..."
            className="focus-visible:ring-0 flex-1 p-0 focus-visible:ring-offset-0 bg-gray-50 rounded-none outline-none border-none"
          />
          <Button
            type="submit"
            className="mt-3 px-7"
